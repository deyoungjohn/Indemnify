...
async def main():
    print("\n--- Project Indemnify Tier 2 Test Script (75% Payout) ---")
    ...
    logger.info("\n[4/4] MANUALLY SETTLING AS TIER 2 (75% Payout) USING ORACLE KEY...")
    ...
    settle_func = escrow_contract.functions.settlePolicy(policy_id, 2) # Tier 2
    await send_tx(w3, oracle_account, settle_func, chain_id)
    
    logger.info("\nSUCCESS: Policy settled as TIER 2!")
    logger.info(f"You should have received exactly 75% of your {coverage_requested} USDT coverage back to your Client Wallet.")
